...
/**
 * An activity that uses WiFi Direct APIs to discover and connect with available devices. WiFi Direct APIs are asynchronous and rely on callback mechanism
using interfaces to notify the application of operation success or failure.
The application should also register a BroadcastReceiver for notification of WiFi state related events.
 */
		...
		DeviceActionListener
{
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case R.id.atn_direct_enable:
		    Log.i(TAG, "===onOptionsItemSelected£¨£©R.id.atn_direct_enable");
		...
		case R.id.atn_direct_discover:
		    Log.i(TAG, "===onOptionsItemSelected£¨£©R.id.atn_direct_discover");
			if (!isWifiP2pEnabled)
			{
